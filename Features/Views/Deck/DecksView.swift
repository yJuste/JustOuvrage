...
#Preview {
	...
	context.insert(Deck(name: "Hello", image: "deck", author: "yJuste"))
	context.insert(Deck(name: "Hellojfkdjk fkdfkhsfkhd hfkdhf ksdhfk kfhsk hshdf khdfkhfksdh kh", image: "deck", author: "yJuste"))
	context.insert(Deck(name: "Hello", image: "deck", author: "yJuste"))
	context.insert(Deck(name: "Hello", image: "deck", author: "yJuste"))
	context.insert(Deck(name: "Hello", image: "deck", author: "yJuste"))
	let all = Deck(name: "All", image: "deck", author: "yJuste")
	context.insert(all)
	return DecksView()
